...
public class PageInfo {
    ...
    private int pre; 		// 이전 여부
    private int next; 		//다음 여부    
    
    public PageInfo() {
        super();
    }
 
    public PageInfo(int currentPage, int listCount, int pageLimit, int maxPage, int startPage, int endPage, int boardLimit, int pre, int next) {
        super();
    ...
    public String toString() {
        return "PageInfo [currentPage=" + currentPage + ", listCount=" + listCount + ", pageLimit=" + pageLimit
                + ", maxPage=" + maxPage + ", startPage=" + startPage + ", endPage=" + endPage + ", boardLimit="+ boardLimit + ", pre=\" + pre + \", next=\"+ next + \"]";
    }
